...
install.packages("rgeos") # This needs installation of UNIX "geos" geospatial library on servers first
install.packages("keras") # This needs special attention
install.packages("BSDA")
install.packages("DBI")
install.packages("kableExtra")
install.packages("skimr")
install.packages("covr")
# starting to move to the correct format
install.packages(c("covr", "rex", "rversions"), lib = "/usr/lib64/R/library")
devtools::install_github("Amherst-Statistics/acstats-thesis", lib = "/usr/lib64/R/library")
...
install.packages("ggbiplot") #needs fixed assuming it works
